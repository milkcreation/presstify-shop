...
use tiFy\Plugins\Shop\Contracts\{EndpointWpPosts as EndpointWpPostContract, OrdersCollection, Order, Shop};
use tiFy\Plugins\Shop\Api\FractalArraySerializer as DataSerializer;
use tiFy\Plugins\Shop\ShopAwareTrait;
use tiFy\Support\{DateTime, ParamsBag};

class EndpointWpPost extends ParamsBag implements EndpointWpPostContract
{
    use ShopAwareTrait;
