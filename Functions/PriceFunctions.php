...
use tiFy\Plugins\Shop\Contracts\{PriceFunctions as PriceFunctionsContract};
use tiFy\Plugins\Shop\ShopAwareTrait;

class PriceFunctions implements PriceFunctionsContract
{
    use ShopAwareTrait;
    ...
    public function html(float $price, ?string $format = null): string
    {
        ...
        $currency_position = $this->shop()->settings()->currencyPosition();
